...
public sealed class InboxManager
{
    ...
    public static InboxCategory Categorize(AlphaInboxItem item) =>
        item.EventType switch
        {
            ...
            LegacyEventType.StaffHired or LegacyEventType.StaffAssigned or LegacyEventType.StaffReassigned or LegacyEventType.StaffRoleChanged or LegacyEventType.StaffReleased or LegacyEventType.StaffConflictWarning or LegacyEventType.StaffEvaluated or LegacyEventType.StaffCandidateGenerated or LegacyEventType.StaffFocusChanged or LegacyEventType.StaffEvaluationCreated or LegacyEventType.TrainingCampOpened or LegacyEventType.TrainingCampEvaluationCreated or LegacyEventType.TrainingCampPlayerKept or LegacyEventType.TrainingCampPlayerCut or LegacyEventType.TrainingCampPlayerAssigned or LegacyEventType.TrainingCampCompleted or LegacyEventType.CoachRosterReview => InboxCategory.Staff,
            LegacyEventType.ScoutAssigned or LegacyEventType.ScoutAssignedToRegion or LegacyEventType.ScoutAssignedToPlayer or LegacyEventType.ScoutAssignmentCompleted or LegacyEventType.ScoutingReportUpdated or LegacyEventType.ScoutingReportCreated or LegacyEventType.ScoutRecommendationUpdated or LegacyEventType.ScoutOffseasonReview => InboxCategory.Scouting,
            LegacyEventType.RecruitingOfferSubmitted
                or LegacyEventType.RecruitCallResult
                or LegacyEventType.RecruitFamilyCallResult
                or LegacyEventType.RecruitVisitUpdated
                or LegacyEventType.RecruitPromiseMade
                or LegacyEventType.RecruitOfferWithdrawn
                or LegacyEventType.RecruitCompetitorUpdate
                or LegacyEventType.ScoutRecruitingNote
                or LegacyEventType.RecruitCommitted
                or LegacyEventType.RecruitRejected
                or LegacyEventType.RecruitingOpened
            ...
            LegacyEventType.ContractOffered
                ...
                or LegacyEventType.TradeCountered
                or LegacyEventType.TradeWithdrawn
                or LegacyEventType.TradeCompleted
