...
public sealed class InboxManager
{
    ...
    public static InboxCategory Categorize(AlphaInboxItem item) =>
        item.EventType switch
        {
            ...
            LegacyEventType.DraftStarted or LegacyEventType.PlayerDrafted or LegacyEventType.DraftCompleted or LegacyEventType.DraftRecapCreated or LegacyEventType.DraftBoardChanged or LegacyEventType.OwnerDraftReaction or LegacyEventType.DraftOpened or LegacyEventType.DraftClosed => InboxCategory.Draft,
