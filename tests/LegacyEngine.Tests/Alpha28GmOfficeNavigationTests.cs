internal sealed class Alpha28GmOfficeNavigationTests
{
    public void DashboardLoadsAsGmOfficeWorkspace()
    {
        ...
        Assert.True(source.Contains("Hockey GM Legacy - Alpha", StringComparison.Ordinal) && source.Contains("- GM Office", StringComparison.Ordinal), "Desktop should identify the current Alpha GM Office.");
